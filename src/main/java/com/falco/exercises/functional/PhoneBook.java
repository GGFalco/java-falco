...
public class PhoneBook {
    ...
    public Optional<Person> searchByLastname(String lastname) {
        return phoneBook.stream().filter(person -> person.getLastname().equals(lastname)).findFirst();
    }

    public Optional<Person> searchByNameAndLastname(String name, String lastname) {
        return phoneBook.stream().filter(person -> person.getLastname().equals(lastname) && person.getName().equals(name)).findFirst();
    }
}
